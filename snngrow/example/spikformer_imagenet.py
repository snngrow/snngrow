...
parser.add_argument('-c', '--config', default='spikformer_imagenet.yml', type=str, metavar='FILE',
                    help='YAML config file specifying default arguments')

parser = argparse.ArgumentParser(description='PyTorch ImageNet Training')

# Dataset / Model parameters
parser.add_argument('-data-dir', metavar='DIR',default='/public/home/wangmiao/dataset/imagenet/',
...
python -m torch.distributed.launch --nproc_per_node=8 spikformer_imagenet.py
